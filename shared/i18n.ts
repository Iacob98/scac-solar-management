  ...
  persist(
    (set, get) => ({
      ...
      translations: {
        ...
        // Статусы проекта (убраны дубликаты)
        'основная_информация': { ru: 'Основная информация', de: 'Grundinformationen' },
        'номер_проекта': { ru: 'Номер проекта', de: 'Projektnummer' },
        'приоритет': { ru: 'Приоритет', de: 'Priorität' },
        'файлы_проекта': { ru: 'Файлы проекта', de: 'Projektdateien' },
        'отчеты': { ru: 'Отчеты', de: 'Berichte' },
        'обратно_к_проектам': { ru: 'Обратно к проектам', de: 'Zurück zu Projekten' },
        'отправить_счет': { ru: 'Отправить счет', de: 'Rechnung senden' },
        'счет_отправлен': { ru: 'Счет отправлен', de: 'Rechnung gesendet' },
        'проект_не_найден': { ru: 'Проект не найден', de: 'Projekt nicht gefunden' },
        'проект_не_существует': { ru: 'Проект с указанным ID не существует или загружается', de: 'Projekt mit angegebener ID existiert nicht oder wird geladen' },
        'временные_рамки_проекта': { ru: 'Временные рамки', de: 'Zeitrahmen' },
        'ожидаемая_поставка': { ru: 'Ожидаемая поставка', de: 'Erwartete Lieferung' },
        'номер_команды': { ru: 'Номер команды', de: 'Team-Nummer' },
        'фактическая_поставка': { ru: 'Фактическая поставка', de: 'Tatsächliche Lieferung' },
        'ожидаемое_начало_работ': { ru: 'Ожидаемое начало работ', de: 'Erwarteter Arbeitsbeginn' },
        'дата_окончания_работ': { ru: 'Дата окончания работ', de: 'Datum der Arbeitsbeendigung' },
        'финансы': { ru: 'Финансы', de: 'Finanzen' },
        'номер_счета': { ru: 'Номер счета', de: 'Rechnungsnummer' },
        ...
        'ожидаемая_дата_поставки': { ru: 'Ожидаемая дата поставки', de: 'Erwartetes Lieferdatum' },
        'фактическая_дата_поставки': { ru: 'Фактическая дата поставки', de: 'Tatsächliches Lieferdatum' },
        'нужен_звонок_оборудование': { ru: 'Нужен звонок по задержке оборудования', de: 'Anruf wegen Ausrüstungsverzögerung erforderlich' },
        'работы': { ru: 'Работы', de: 'Arbeiten' },
        'дата_начала_работ': { ru: 'Дата начала работ', de: 'Datum des Arbeitsbeginns' },
        'нужен_звонок_бригада': { ru: 'Нужен звонок по задержке бригады', de: 'Anruf wegen Crew-Verzögerung erforderlich' },
        'нужен_звонок_даты': { ru: 'Нужен звонок по изменению дат', de: 'Anruf wegen Datumsänderung erforderlich' },
        'добавить_фото': { ru: 'Добавить фото', de: 'Foto hinzufügen' },
        'добавить_файл_проекта': { ru: 'Добавить файл проекта', de: 'Projektdatei hinzufügen' },
        'тип_файла': { ru: 'Тип файла', de: 'Dateityp' },
        'фото_отчет_работы': { ru: 'Фото отчет выполненной работы', de: 'Foto-Bericht der ausgeführten Arbeit' },
        'документ_отзыва': { ru: 'Документ отзыва (PDF/фото)', de: 'Bewertungsdokument (PDF/Foto)' },
        'документ_приемки': { ru: 'Документ приемки', de: 'Abnahmedokument' },
        'название_файла': { ru: 'Название файла', de: 'Dateiname' },
        'введите_название_файла': { ru: 'Введите название файла', de: 'Dateiname eingeben' },
