  ...
  async getFirms(): Promise<Firm[]> {
    return await db
      .select({
        ...
        smtpHost: firms.smtpHost,
        smtpPort: firms.smtpPort,
        smtpUser: firms.smtpUser,
        smtpPassword: firms.smtpPassword,
        smtpSecure: firms.smtpSecure,
        smtpFrom: firms.smtpFrom,
